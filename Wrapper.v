...
initial begin
			...
			INSTR_MEM[1] = 32'hE59F2214; 
			INSTR_MEM[2] = 32'hE5913000; 
			INSTR_MEM[3] = 32'hE59F41EC; 
			INSTR_MEM[4] = 32'hE0050493; 
			INSTR_MEM[5] = 32'hE5825000; 
			INSTR_MEM[6] = 32'hE025A493; 
...
//----------------------------------------------------------------
initial begin
			DATA_CONST_MEM[0] = 32'h00000003; 
			DATA_CONST_MEM[1] = 32'h00000000; 
			DATA_CONST_MEM[2] = 32'h00000100; 
			DATA_CONST_MEM[3] = 32'h55555555; 
			DATA_CONST_MEM[4] = 32'h00000C00; 
			DATA_CONST_MEM[5] = 32'h00000C04; 
			DATA_CONST_MEM[6] = 32'h00000C08; 
			DATA_CONST_MEM[7] = 32'h00000C0C; 
			DATA_CONST_MEM[8] = 32'h00000C18; 
...
assign dec_LED				= (ALUResult == 32'h00000C00) ? MemWrite : 1'b0;
...
assign dec_7SEG	    		= (ALUResult == 32'h00000C18) ? MemWrite : 1'b0;
